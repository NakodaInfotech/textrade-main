...
class SaleOrderListController extends GetxController {
  var fromTextController = TextEditingController();
  var toTextController = TextEditingController();

  var challanGDNModel = SaleOrderListModel().obs;
  ...
  getChallanList() async {
    ...
    challanGDNModel.value = await ApiUtility.shared.getSaleOrderList(
  ...
  selectOrDeselectChallan(SaleOrderListTable? table) {
    if (table != null) {
